...
<?
	if($mode=='search') {
		...
		if($major_intro) {
			$sear_char .=' and major_intro like \'%'.$major_intro.'%\'';
		}
	}

	$query = "select * from entrance1 where 1 $sear_char";
	$result = mysql_query($query, $connect);
	$total = mysql_num_rows($result);
?>

<form name="mb" method="post" action="entrance1_list.php">
...
<td width="150" height="20" align="center" bgcolor="#F1F1F1">
	...
	<td width="250" height="20">
<input type="text" name="major_intro" value="<?=$major_intro?>" size=20 class="input">
	</td>
	</tr>
<tr>
	<td colspan="4">
...
<tr>
	<td align="center" bgcolor="#f5f5f5"><strong>학과이름</strong></td>
	<td align="center" bgcolor="#f5f5f5"><strong>학과소개</strong></td>
	<td align="center" bgcolor="#f5f5f5"><strong>학과이미지</strong></td>
...
?>
	<tr bgcolor="#ffffff">
		<td align="center"><a href="javascript:open_win('entrance1_view.php?num=<?=$rows4[id]?>','nwin','scrollbars=no, width=600, height=400')"><?=$rows4[major]?></a></td>
		<td align="center"><?=$rows4[major_intro]?></a></td>
		<td align="center">
		<img src="/upload/entrance1/<?=$rows4[imgae_location]?>" width="100">
		</td>
		<td align="center" colspan="2">
<a href="entrance1_delete.php?m_num=<?=$rows4[id]?>&page=<?=$page?>" onclick="return confirm('삭제를 하게되면 이 입학에 관한 모든 정보가 삭제됩니다. \n 정말 삭제하시겠습니까?')">
삭제</a>
		</td>
	</tr>
<?	} 
...
<?
		$url="entrace1_list.php?id=$id&major=$major&mode=$mode&major_intro=$major_intro";
