...
<?
	$query = "select * from experience2 where id=$num";
	$result = mysql_query($query, $connect);
	$rows = mysql_fetch_array($result);
?>
<form name="primary" method="post" action="experience2_view_edit.php">
...
<td>코드</td>
<td>
<input type="text" name="coding" value="<?=$rows[coding]?>">
</td>
</tr>
...
<td>
<input type="text" name="e_result2" value="<?=$rows[result]?>">
</td>
</tr>
</table>
<br>
