...
<?
	$query = "select * from rule where id=$num";
	$result = mysql_query($query, $connect);
	$rows = mysql_fetch_array($result);
?>
<form name="primary" method="post" action="rule_view_edit.php">
...
<td>
	<table>
		<tr>
<td >번호</td>
<td><input type="text" name="division_number" value="<?=$rows[number]?>"></td>
		</tr>

<tr>
<td>구분번호</td>
<td>
<input type="text" name="division_number" value="<?=$rows[division_number]?>">
</td>
</tr>
