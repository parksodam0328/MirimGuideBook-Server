				...
				<!-- Menu -->
					<nav id="menu">
						...
						<ul>
							...
							<li><a href="entrance.php">Admission</a></li>
							<li><a href="experience.php">Entrance</a></li>
...
<?
	$query = "select * from club where id=$num";
	$result = mysql_query($query, $connect);
	$rows = mysql_fetch_array($result);
?>
<form name="primary" method="post" action="club_view_edit.php">
...
<td>
<input type="text" name="club_name" value="<?=$rows[club_name]?>">
</td>
</tr>
...
<td>
<input type="text" name="club_room" value="<?=$rows[club_room]?>">
</td>
</tr>

<tr>
<td>담당 선생님</td>
<td><input type="text" name="teacher" value="<?=$rows[teacher]?>">
</td>
</tr>
...
<td>소개</td>
<td>
<input type="text" name="intro" value="<?=$rows[intro]?>">
</td>
</tr>
</table>
<br>
