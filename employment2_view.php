...
<?
	$query = "select * from employment2 where id=$num";
	$result = mysql_query($query, $connect);
	$rows = mysql_fetch_array($result);
?>
<form name="primary" method="post" action="employment2_view_edit.php">
...
<td>
	<table>
		<tr>
<td>회사명</td>
<td><input type="text" name="company_name" value="<?=$rows[company_name]?>"></td>
		</tr>

<tr>
<td>분야</td>
<td>
<input type="text" name="field" value="<?=$rows[field]?>">
</td>
</tr>
<tr>
<td>홈페이지 주소</td>
<td>
<input type="text" name="website" value="<?=$rows[website]?>">
</td>
</tr>
</table>
<br>
