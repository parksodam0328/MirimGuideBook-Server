...
header("Content-Type: text/html; charset=UTF-8");
 ...
 $img_dir = $_SERVER['DOCUMENT_ROOT']."/upload/location2";           //저장 디렉토리
...
//타임 및 난수를 이용해서 기존 파일명 대신 사용할려고 함
 ...
 if(copy($img_tmp, $save_name)) {     //파일 업로드
  ...
  unlink($img_tmp);
	...
	$query = "insert into location(school_office, floor, teacher, intro, image_type, image_location)
	values('$school_office','$floor','$teacher','$intro', '$extension','$up_filename')"; 
