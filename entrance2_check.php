...
header("Content-Type: text/html; charset=UTF-8");
 ...
 $img_dir = $_SERVER['DOCUMENT_ROOT']."/upload/entrance2";           //저장 디렉토리
 $img_tmp = $_FILES['poster']['tmp_name'];             //임시 파일명
 $img_type = $_FILES['poster']['type'];             //저장가능 이미지 타입
 $img_name = $_FILES['poster']['name'];             //파일명(ex : xxxx.jpg)
...
$query = "insert into entrance2(date, room, apply, image_type, image_location)
values('$date','$room','$apply','$extension','$up_filename')"; 
