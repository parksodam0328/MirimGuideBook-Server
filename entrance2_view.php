...
<?
	$query = "select * from entrance2 where id=$num";
	$result = mysql_query($query, $connect);
	$rows = mysql_fetch_array($result);
?>
<form name="primary" method="post" action="entrance2_view_edit.php">
...
<td>
	<table>
		<tr>
<td >날짜</td>
<td><input type="text" name="date" value="<?=$rows[date]?>"></td>
		</tr>
...
<td>신청방법</td>
<td>
<input type="text" name="apply" value="<?=$rows[apply]?>">
</td>
</tr>
<tr>
<td>이미지</td>
...
<td>
<img src="/upload/entrance2/<?=$rows[image_location]?>" width="300">
</td>
</tr>
</table>
<br>
