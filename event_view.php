...
<?
	$query = "select * from event where id=$num";
	$result = mysql_query($query, $connect);
	$rows = mysql_fetch_array($result);
?>
<form name="primary" method="post" action="event_view_edit.php">
...
<td>
	<table>
		<tr>
<td >행사명</td>
<td><input type="text" name="event_name" value="<?=$rows[event_name]?>"></td>
		</tr>
...
<td>이미지</td>
<td>
<img src="/upload/event/<?=$rows[event_image]?>" width="300">
</td>
</tr>
</table>
<br>
