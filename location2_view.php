...
<?
	$query = "select * from location1 where id=$num";
	$result = mysql_query($query, $connect);
	$rows = mysql_fetch_array($result);
?>
<form name="primary" method="post" action="location1_view_edit.php">
...
<td>
	<table>
		<tr>
<td >교무실이름</td>
<td><input type="text" name="school_office" value="<?=$rows[school_office]?>"></td>
		</tr>

<tr>
<td>층</td>
<td>
<input type="text" name="floor" value="<?=$rows[floor]?>">
</td>
</tr>
...
<td>이미지</td>
<td>
<img src="/upload/location2/<?=$rows[image_location]?>" width="300"></td>
</td>
</tr>
