...
header("Content-Type: text/html; charset=UTF-8");
 ...
 $img_dir = $_SERVER['DOCUMENT_ROOT']."/upload/event";           //저장 디렉토리
 $img_tmp = $_FILES['event_image']['tmp_name'];             //임시 파일명
 $img_type = $_FILES['event_image']['type'];             //저장가능 이미지 타입
 $img_name = $_FILES['event_image']['name'];             //파일명(ex : xxxx.jpg)
...
$query = "insert into event(event_name, date, content, event_image)
			values('$event_name', '$date', '$content', '$up_filename')"; 
