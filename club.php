...
<html>
	<head>
		...
		<!--[if lte IE 8]><script src="assets/js/ie/html5shiv.js"></script><![endif]--><script src="assets/js/jquery.min.js"></script>
								...
								<table>
									<tr>
										...
										<tr>
											<td colspan="7">
											<center>
											<a href="javascript:checkClubInput()"><input type="button" value="확인"></a>
