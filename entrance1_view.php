...
<?
	$query = "select * from entrance1 where id=$num";
	$result = mysql_query($query, $connect);
	$rows = mysql_fetch_array($result);
?>
<form name="primary" method="post" action="entrance1_view_edit.php">
...
<td>
	<table>
		<tr>
<td >학과이름</td>
<td><input type="text" name="major" value="<?=$rows[major]?>"></td>
		</tr>

<tr>
<td>학과소개</td>
<td>
<input type="text" name="major_intro" value="<?=$rows[major_intro]?>">
</td>
</tr>
...
<td>
<img src="/upload/entrance1/<?=$rows[imgae_location]?>" width="300">
</td>
</tr>
</table>
<br>
