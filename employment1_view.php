...
<?
	$query = "select * from employment1 where id=$num";
	$result = mysql_query($query, $connect);
	$rows = mysql_fetch_array($result);
?>
<form name="primary" method="post" action="employment1_view_edit.php">
...
<td>취업현황</td>
<td>
<input type="text" name="employ_now" value="<?=$rows[employ_now]?>">
</td>
</tr>
</table>
<br>
