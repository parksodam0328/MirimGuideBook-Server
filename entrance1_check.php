...
header("Content-Type: text/html; charset=UTF-8");
 ...
 $img_dir = $_SERVER['DOCUMENT_ROOT']."/upload/entrance1";           //저장 디렉토리
 $img_tmp = $_FILES['major_image']['tmp_name'];             //임시 파일명
 $img_type = $_FILES['major_image']['type'];             //저장가능 이미지 타입
 $img_name = $_FILES['major_image']['name'];             //파일명(ex : xxxx.jpg)
...
$query = "insert into entrance1(major, major_intro, image_type, imgae_location)
values('$major','$major_intro','$extension','$up_filename')"; 
