...
<?
	$query = "select * from experience1 where id=$num";
	$result = mysql_query($query, $connect);
	$rows = mysql_fetch_array($result);
?>
<form name="primary" method="post" action="experience1_view_edit.php">
...
<td>용어</td>
<td>
<input type="text" name="word" value="<?=$rows[word]?>">
</td>
</tr>
...
<td>
<input type="text" name="means" value="<?=$rows[means]?>">
</td>
</tr>
</table>
<br>
