...
<?
	$query = "select * from entrance3 where id=$num";
	$result = mysql_query($query, $connect);
	$rows = mysql_fetch_array($result);
?>
<form name="primary" method="post" action="entrance3_view_edit.php">
...
<td>
	<table>
		<tr>
<td >번호</td>
<td><input type="text" name="number" value="<?=$rows[number]?>"></td>
		</tr>

<tr>
<td>제목</td>
<td>
<input type="text" name="title" value="<?=$rows[title]?>">
</td>
</tr>
<tr>
<td>내용</td>
