				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<center>
							<form name="form1" method="post" action="subject_check.php">
								<table>
									<tr>
										<td>
											<table width="100%">
										...
										<tr>
											<td>과목</td>
											<td><input type="text" name="name_sub"></td>
										</tr>
										<tr>
											<td>과목 소개</td>
											<td><textarea type="text" name="intro_sub" cols="50" rows="15"></textarea></td>
										</tr>
										<tr>
											<td>선생님 성함</td>
